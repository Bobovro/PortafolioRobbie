...
export const AUDIT_ITEMS = [
  { iso: '2025-12-27T21:34:00', type: 'Feature', title: 'Mapa de referencia', description: 'Se agregó mapa Lima con zonas destacadas.' },
  { iso: '2025-12-27T20:10:00', type: 'Fix', title: 'Home responsive', description: 'Ajuste de cards y spacing en móvil.' },
